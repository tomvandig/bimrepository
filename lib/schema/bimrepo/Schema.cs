...
public struct Schema : IFlatbufferObject
{
  ...
  public ushort ReferenceId { get { int o = __p.__offset(6); return o != 0 ? __p.bb.GetUshort(o + __p.bb_pos) : (ushort)0; } }
  ...
  public string Schemaversion { get { int o = __p.__offset(10); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSchemaversionBytes() { return __p.__vector_as_span<byte>(10, 1); }
#else
  public ArraySegment<byte>? GetSchemaversionBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public byte[] GetSchemaversionArray() { return __p.__vector_as_array<byte>(10); }
  public string Comment { get { int o = __p.__offset(12); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCommentBytes() { return __p.__vector_as_span<byte>(12, 1); }
#else
  ...
  public bimrepo.shape? SchemaShape { get { int o = __p.__offset(16); return o != 0 ? (bimrepo.shape?)(new bimrepo.shape()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }

  public static Offset<bimrepo.Schema> CreateSchema(FlatBufferBuilder builder,
      VectorOffset idOffset = default(VectorOffset),
      ushort reference_id = 0,
    ...
    Schema.AddReferenceId(builder, reference_id);
    return Schema.EndSchema(builder);
  }

  public static void StartSchema(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static void AddReferenceId(FlatBufferBuilder builder, ushort referenceId) { builder.AddUshort(1, referenceId, 0); }
  public static void AddHash(FlatBufferBuilder builder, StringOffset hashOffset) { builder.AddOffset(2, hashOffset.Value, 0); }
  public static void AddSchemaversion(FlatBufferBuilder builder, StringOffset schemaversionOffset) { builder.AddOffset(3, schemaversionOffset.Value, 0); }
  ...
  public static void AddSchemaShape(FlatBufferBuilder builder, Offset<bimrepo.shape> schemaShapeOffset) { builder.AddOffset(6, schemaShapeOffset.Value, 0); }
...
static public class SchemaVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*ReferenceId*/, 2 /*ushort*/, 2, false)
      && verifier.VerifyString(tablePos, 8 /*Hash*/, false)
      && verifier.VerifyString(tablePos, 10 /*Schemaversion*/, false)
      && verifier.VerifyString(tablePos, 12 /*Comment*/, false)
      && verifier.VerifyString(tablePos, 14 /*Description*/, false)
      && verifier.VerifyTable(tablePos, 16 /*SchemaShape*/, bimrepo.shapeVerify.Verify, false)
