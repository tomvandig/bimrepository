...
function genPropertyExportCode(name, property)
{
    ...
    else if (property.type === "string")
    {
        return `
            // property ${name}
            componentObj.data.push(MakeString(this.${name}));
        `;
    }
    else if (property.type === "bool")
    {
        return `
            // property ${name}
            componentObj.data.push(MakeBool(this.${name}));
        `;
    }
    else
    {
...
function genPropertyImportCode(name, property)
{
    ...
    else if (property.type === "string")
    {
        return `
            // property ${name}
            {
                obj.${name} = GetString(componentObj);
            }
        `;
    }
    else if (property.type === "bool")
...
function convert(inputFile, outputdir, libPrefix)
{
    ...
    let fbimports = [
        ...
        `import { ECSComponent } from '${libPrefix}/client/ts/ecs';`,
